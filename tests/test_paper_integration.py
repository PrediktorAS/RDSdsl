...
to 2021-01-31 23:59:59+00:00
    ...
    rescols = actual_df.columns.to_list()

    actual_df = actual_df.sort_values(by=rescols, ignore_index=True).copy()
    ...
    expected_df = expected_df[rescols].sort_values(by=rescols, ignore_index=True).copy()
